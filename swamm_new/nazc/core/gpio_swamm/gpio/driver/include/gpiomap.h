...
#define GP_DEBUG_LED0_OUT			2		// DEBUG LED0 신호
#define GP_DEBUG_LED1_OUT			3		// DEBUG LED1 신호
#define GP_DEBUG_LED2_OUT			4		// DEBUG LED2 신호
#define GP_DEBUG_LED3_OUT			5		// DEBUG LED0 신호
