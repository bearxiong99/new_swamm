...
OSAKI_OPTION_TBL osakiOptionTbl_ondemand [] = {       // Ondemand default
    {IDX_CONFIRM, " ADDRESS CONFIRM"},
    {IDX_PASSWORD, " IEC21 PASSWORD"},
    {IDX_REQ_PULSE, " CURRENT PULSE"},
    {IDX_REQ_RELAY_STATUS, " REQ RELAY STATUS"},
    {0, NULL}
};
...
OSAKI_OPTION_TBL osakiOptionTbl_relay_connect [] = {      // Relay connect
    {IDX_CONFIRM, " ADDRESS CONFIRM"},
    {IDX_PASSWORD, " IEC21 PASSWORD"},
    {IDX_CMD_RELAY_CONNECT, " EXE RELAY CONNECT"},
    //{IDX_REQ_RELAY_STATUS, " REQ RELAY STATUS"}, TODO RelayTimeout
    {0, NULL}
};
...
OSAKI_OPTION_TBL osakiOptionTbl_relay_disconnect [] = {      // Relay disconnect
    {IDX_CONFIRM, " ADDRESS CONFIRM"},
    {IDX_PASSWORD, " IEC21 PASSWORD"},
    {IDX_CMD_RELAY_DISCONNECT, " EXE RELAY DISCONNECT"},
    //{IDX_REQ_RELAY_STATUS, " REQ RELAY STATUS"}, TODO RelayTimeout
    {0, NULL}
};
