...
extern VAROBJECT	m_varValueMask_node[];
extern VAROBJECT	m_varGeEntry_node[];
extern VAROBJECT	m_varEvtCfgEntry_node[];
extern VAROBJECT	m_varAutoResetCheckInterval_node[];
extern VAROBJECT	m_varSysPowerOffDelay_node[];
extern VAROBJECT	m_varSysTempMonInterval_node[];
extern VAROBJECT	m_varAutoTimeSyncInterval_node[];
extern VAROBJECT	m_varSysMeteringThreadCount_node[];
extern VAROBJECT	m_varSensorTimeout_node[];
extern VAROBJECT	m_varSensorKeepalive_node[];
extern VAROBJECT	m_varSensorMeterSaveCount_node[];
extern VAROBJECT	m_varMeterDayMask_node[];
extern VAROBJECT	m_varMeterHourMask_node[];
extern VAROBJECT	m_varMeterStartMin_node[];
extern VAROBJECT	m_varRecoveryDayMask_node[];
extern VAROBJECT	m_varRecoveryHourMask_node[];
extern VAROBJECT	m_varRecoveryStartMin_node[];
extern VAROBJECT	m_varCmdHistSaveDay_node[];
extern VAROBJECT	m_varEventLogSaveDay_node[];
extern VAROBJECT	m_varCommLogSaveDay_node[];
extern VAROBJECT	m_varMeterLogSaveDay_node[];
extern VAROBJECT	m_varAutoResetTime_node[];
extern VAROBJECT	m_varMeterUploadCycleType_node[];
extern VAROBJECT	m_varMeterUploadCycle_node[];
extern VAROBJECT	m_varMeterUploadStartHour_node[];
extern VAROBJECT	m_varMeterUploadStartMin_node[];
extern VAROBJECT	m_varMeterUploadRetry_node[];
extern VAROBJECT	m_varMeterIssueDate_node[];
extern VAROBJECT	m_varMemoryCriticalRate_node[];
extern VAROBJECT	m_varFlashCriticalRate_node[];
extern VAROBJECT	m_varSubValueEntry_node[];
extern VAROBJECT	m_varSubValueMask_node[];
extern VAROBJECT	m_varSubChannel_node[];
extern VAROBJECT	m_varSubPanID_node[];
extern VAROBJECT	m_usrEntry_node[];
extern VAROBJECT	m_usrMask_node[];
extern VAROBJECT	m_usrAccount_node[];
extern VAROBJECT	m_usrPassword_node[];
extern VAROBJECT	m_usrGroup_node[];
extern VAROBJECT	m_gpsEntry_node[];
extern VAROBJECT	m_memEntry_node[];
extern VAROBJECT	m_memTotalSize_node[];
extern VAROBJECT	m_memFreeSize_node[];
extern VAROBJECT	m_memUseSize_node[];
extern VAROBJECT	m_memCacheSize_node[];
extern VAROBJECT	m_memBufferSize_node[];
extern VAROBJECT	m_flashEntry_node[];
extern VAROBJECT	m_flashTotalSize_node[];
extern VAROBJECT	m_flashFreeSize_node[];
extern VAROBJECT	m_flashUseSize_node[];
extern VAROBJECT	m_ethEntry_node[];
extern VAROBJECT	m_ethName_node[];
extern VAROBJECT	m_ethPhyAddr_node[];
extern VAROBJECT	m_ethIpAddr_node[];
extern VAROBJECT	m_ethSubnetMask_node[];
extern VAROBJECT	m_ethGateway_node[];
extern VAROBJECT	m_gpioEntry_node[];
extern VAROBJECT	m_gpioMask_node[];
extern VAROBJECT	m_gpioPowerFail_node[];
extern VAROBJECT	m_gpioLowBattery_node[];
extern VAROBJECT	m_gpioBUSY_node[];
extern VAROBJECT	m_gpioSTBY_node[];
extern VAROBJECT	m_gpioDCD_node[];
extern VAROBJECT	m_gpioRI_node[];
extern VAROBJECT	m_gpioCtrlEntry_node[];
extern VAROBJECT	m_mobileEntry_node[];
extern VAROBJECT	m_mobileID_node[];
extern VAROBJECT	m_mobileIpaddr_node[];
extern VAROBJECT	m_mobileRxDbm_node[];
extern VAROBJECT	m_mobileTxDbm_node[];
extern VAROBJECT	m_mobilePacketLiveTime_node[];
extern VAROBJECT	m_mobileSendBytes_node[];
extern VAROBJECT	m_mobileRecvBytes_node[];
extern VAROBJECT	m_mobileLastConnectTime_node[];
extern VAROBJECT	m_pluginEntry_node[];
extern VAROBJECT	m_pluginName_node[];
extern VAROBJECT	m_pluginFileName_node[];
extern VAROBJECT	m_pluginDescr_node[];
extern VAROBJECT	m_pluginType_node[];
extern VAROBJECT	m_pluginState_node[];
extern VAROBJECT	m_pluginVersion_node[];
extern VAROBJECT	m_procEntry_node[];
extern VAROBJECT	m_procID_node[];
extern VAROBJECT	m_procTTY_node[];
extern VAROBJECT	m_procSize_node[];
extern VAROBJECT	m_procState_node[];
extern VAROBJECT	m_procCmd_node[];
extern VAROBJECT	m_pppEntry_node[];
extern VAROBJECT	m_pppProvider_node[];
extern VAROBJECT	m_pppUser_node[];
extern VAROBJECT	m_pppPassword_node[];
extern VAROBJECT	m_envEntry_node[];
extern VAROBJECT	m_patchEntry_node[];
extern VAROBJECT	m_fwEntry_node[];
extern VAROBJECT	m_envKernelVersion_node[];
extern VAROBJECT	m_envGccVersion_node[];
extern VAROBJECT	m_envCpuName_node[];
extern VAROBJECT	m_envCpuMips_node[];
extern VAROBJECT	m_commLogEntry_node[];
extern VAROBJECT	m_commLogDate_node[];
extern VAROBJECT	m_commLogFileName_node[];
extern VAROBJECT	m_commLogFileSize_node[];
extern VAROBJECT	m_commLogStruct_node[];
extern VAROBJECT	m_commLogLength_node[];
extern VAROBJECT	m_commLogMin_node[];
extern VAROBJECT	m_commLogSec_node[];
extern VAROBJECT	m_commLogData_node[];
extern VAROBJECT	m_cmdHistEntry_node[];
extern VAROBJECT	m_cmdHistDate_node[];
extern VAROBJECT	m_cmdHistFileName_node[];
extern VAROBJECT	m_cmdHistFileSize_node[];
extern VAROBJECT	m_cmdHistStruct_node[];
extern VAROBJECT	m_cmdHistLength_node[];
extern VAROBJECT	m_cmdHistTimeHour_node[];
extern VAROBJECT	m_cmdHistTimeMin_node[];
extern VAROBJECT	m_cmdHistTimeSec_node[];
extern VAROBJECT	m_cmdHistOwner_node[];
extern VAROBJECT	m_cmdHistUser_node[];
extern VAROBJECT	m_cmdHistData_node[];
extern VAROBJECT	m_mcuEventEntry_node[];
extern VAROBJECT	m_mcuEvnetDate_node[];
extern VAROBJECT	m_mcuEventFileName_node[];
extern VAROBJECT	m_mcuEventFileSize_node[];
extern VAROBJECT	m_mcuEventStruct_node[];
extern VAROBJECT	m_mcuEventLength_node[];
extern VAROBJECT	m_mcuEventData_node[];
extern VAROBJECT	m_meterLogEntry_node[];
extern VAROBJECT	m_meterLogDate_node[];
extern VAROBJECT	m_meterLogFileName_node[];
extern VAROBJECT	m_meterLogFileSize_node[];
extern VAROBJECT	m_meterLogStruct_node[];
extern VAROBJECT	m_meterLogID_node[];
extern VAROBJECT	m_meterLogType_node[];
extern VAROBJECT	m_meterLogTime_node[];
extern VAROBJECT	m_meterLogStartTime_node[];
extern VAROBJECT	m_meterLogEndTime_node[];
extern VAROBJECT	m_meterLogResult_node[];
extern VAROBJECT	m_meterLogElapse_node[];
extern VAROBJECT	m_meterLogTryCount_node[];
extern VAROBJECT	m_mobileLogEntry_node[];
extern VAROBJECT    m_mobileLogStruct_node[];
extern VAROBJECT	m_mobileLogDate_node[];
extern VAROBJECT	m_mobileLogFileName_node[];
extern VAROBJECT	m_mobileLogFileSize_node[];
...
typedef struct _tagSYSENTRY
{
    ...
    UINT        sysPowerType;
    UINT        sysStateMask;
    BYTE        sysSecurityState;                   //  [9/13/2010 DHKim] SSL Security
...
typedef struct _tagVARVALUEENTRY
{
    ...
    int         varHeaterOnTemp;
    int         varHeaterOffTemp;
	int			varMobileLiveCheckInterval;
    UINT        varEventReadDayMask;
    UINT        varEventReadHourMask;
    UINT        varEventSendDelay;
	BYTE		varEventAlertLevel;
	int		    varSensorLimit;
	BYTE		varMeteringStrategy;
	int         varTimesyncThresholdLow;
	BYTE		varMobileLiveCheckMethod;
	BYTE		varScanningStrategy;
...
typedef struct _tagSINKENTRY
{
	...
	BYTE        sinkChannel;
	WORD        sinkPanID;
	BYTE        sinkNeighborNode;
	signed char sinkRfPower;
	UINT        sinkBaudrate;
	BYTE        sinkState;
	BYTE        sinkMaxActiveCount;
	BYTE        sinkResetKind;
	WORD        sinkPC;
	TIMESTAMP   sinkLastConnect;
	TIMESTAMP   sinkLastDisconnect;
	TIMESTAMP   sinkLastReset;
} __attribute__ ((packed)) SINKENTRY;

typedef struct _tagSINKSTATICENTRY
{
	BYTE        sinkStaticIndex;
	UINT        sinkRecvBytes;
	UINT        sinkSendBytes;
	UINT        sinkErrorBytes;
	UINT        sinkRecvPacket;
	UINT        sinkSendPacket;
	UINT        sinkTimeoutPacket;
	UINT        sinkSeqErrorPacket;
	UINT        sinkCrcErrorPacket;
	UINT        sinkSendDropPacket;
	WORD        sinkResetCount;
} __attribute__ ((packed)) SINKSTATICENTRY;
