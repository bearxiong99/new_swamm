...
////////////////////////////////////////////////////////////////////
// Issue #977 : Kamstrup New Format Load Profile Log Data Format
//////////////////////////////////////////////////////////////////////

typedef struct	_tagENDI_KAM_LPLOG_INFO
{
		BYTE		LPPERIOD;								// LP 주기
        BYTE        LPCHANNEL;                              // LP Channel Info bit3:R34, bit2:R12, bit1:A23, bit0:A14
		WORD24      LPTIMEFORMAT;                           // LP Time Format
		WORD24      LPCHFORMAT[4];                          // LP Channel 1 ~ 4 Format
        WORD        LPLASTIDX;                              // LP Last Index (2 Bytes)
        BOOL        LPOVERLAP;                              // LP Overlap 여부
        WORD        LPMAXCOUNT;                             // LP 최대 개수
        UINT        LPPOINTER;                              // 다음에 LP를 기록할 주소 
}	__ATTRIBUTE_PACKED__ ENDI_KAM_LPLOG_INFO;

typedef struct	_tagENDI_KAM_OMNI_LPLOG_INFO
{
		BYTE		LPPERIOD;								// LP 주기
        BYTE        LPCHANNEL;                              // LP Channel Info bit3:R34, bit2:R12, bit1:A23, bit0:A14
		WORD24      LPTIMEFORMAT;                           // LP Time Format
		WORD24      LPCHFORMAT[4];                          // LP Channel 1 ~ 4 Format
        UINT        LPLASTIDX;                              // LP Last Index (4 Bytes)
        BOOL        LPOVERLAP;                              // LP Overlap 여부
        WORD        LPMAXCOUNT;                             // LP 최대 개수
        UINT        LPPOINTER;                              // 다음에 LP를 기록할 주소 
}	__ATTRIBUTE_PACKED__ ENDI_KAM_OMNI_LPLOG_INFO;
