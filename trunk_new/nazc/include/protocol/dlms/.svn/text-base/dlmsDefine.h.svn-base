...
#define DLMS_CONFIRMED_SERVICE_ERROR            0x03
...
#define DLMS_ACTION                             0x02
#define DLMS_METHOD_MASK                        0x03
#endif

// readRequest/writeRequest에는 적용되지 않는다
#define DLMS_FLOW_MASK                          0x04
...
/** DLMS ConfirmedService Error */
#define CONF_INITIATE_ERR                       0x01
#define CONF_READ_ERR                           0x05
#define CONF_WRITE_ERR                          0x06

/** DLMS Service Error */
#define  SERVICE_ERR_OTHER                      0x00
// application reference[0]
#define  SERVICE_ERR_TIME_ELAPSED               0x01
#define  SERVICE_ERR_APPLICATION_UNREACHABLE    0x02
#define  SERVICE_ERR_APPLICATION_REFERENCE_INVALID      0x03
#define  SERVICE_ERR_APPLICATION_CONTEXT_UNSUPPORTED    0X04
#define  SERVICE_ERR_PROVIDER_COMMUNICATION     0X05
#define  SERVICE_ERR_DECIPHERING                0x00
// hardware-resource[1]    
#define  SERVICE_ERR_MEMORY_UNAVAILABLE         0x01
#define  SERVICE_ERR_PROCESSOR_RESOURCE_UNACAILABLE 0x02
#define  SERVICE_ERR_MASS_STORAGE_UNAVAILABLE   0x03
#define  SERVICE_ERR_OTHER_RESOURCE_UNAVAILABLE 0x04
// vde-state-error[2]
#define  SERVICE_ERR_NO_DLMS_CONTEXT            0x01
#define  SERVICE_ERR_LOADING_DATA_SET           0x02
#define  SERVICE_ERR_STATUS_NOCHANGE            0x03
#define  SERVICE_ERR_STATUS_INOPERABLE          0x04
// service[3]
#define  SERVICE_ERR_PDU_SIZE                   0x01
#define  SERVICE_ERR_SERVICE_UNSUPPORTED        0x02
// definition[4]
#define  SERVICE_ERR_UNDEFINED                  0x01
#define  SERVICE_ERR_CLASS_INCONSISTENT         0x02
#define  SERVICE_ERR_ATTRIBUTE_INCONSISTENT     0x03
// access[5]
#define  SERVICE_ERR_SCOPE_OF_ACCESS_VIOLATED   0x01
#define  SERVICE_ERR_OBJECT_ACCESS_INVALID      0x02
#define  SERVICE_ERR_HARDWARE_FAULT             0x03
#define  SERVICE_ERR_OBJECT_UNAVAILABLE         0x04
// initiate[6]
#define  SERVICE_ERR_DLMS_VERSION_TOO_LOW       0x01
#define  SERVICE_ERR_INCOMPATIBLE_CONFORMANCE   0x02
#define  SERVICE_ERR_PDU_SIZE_TOO_SHORT         0x03
#define  SERVICE_ERR_REFUSED_BY_THE_VDE_HANDLER 0x04
// load-data-set[7]
#define  SERVICE_ERR_PRIMITIVE_OUT_OF_SEQUENCE  0x01
#define  SERVICE_ERR_NOT_LOADABLE               0x02
#define  SERVICE_ERR_DATASET_SIZE_TOO_LARGE     0x03
#define  SERVICE_ERR_NOT_AWAITED_SEGMENT        0x04
#define  SERVICE_ERR_INTERPRETATION_FAILURE     0x05
#define  SERVICE_ERR_STORAGE_FAILURE            0x06
#define  SERVICE_ERR_DATA_SET_NOT_READY         0x07
// task[9]
#define  SERVICE_ERR_NO_REMOTE_CONTROL          0x01
#define  SERVICE_ERR_TI_STOPPED                 0x02
#define  SERVICE_ERR_TI_RUNNING                 0x03
#define  SERVICE_ERR_TI_UNUSABLE                0x04
