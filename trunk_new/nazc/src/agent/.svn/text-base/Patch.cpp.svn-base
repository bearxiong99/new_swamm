...
PATCHENTRY m_oPatchInformation[] = {
    ...
    {12, 969, FALSE, "Enable Reverse SSH Tunnel" },         // SSH를 이용한 Reverse Tunnel 생성
#else
    { UINT_MAX, 0, FALSE, "" },
#endif
#if     defined(__PATCH_13_1266__)
    {13, 1266, FALSE, "Disable SIGSEGV reboot handler" },   // SIGSEGV reboot handler를 disable 시킨다
#else
    { UINT_MAX, 0, FALSE, "" },
#endif
#if     defined(__PATCH_14_1286__)
    {14, 1286, FALSE, "Disable fixed reset at power fail status" },   // Power fail 상태에서 fixed reset을 하지 않게 한다
#else
    { UINT_MAX, 0, FALSE, "" },
#endif
    { 0, 0, FALSE, "" }
...
#endif
#if     defined(__PATCH_12_969__)
BOOL    *m_pbPatch_12_969 = &(m_oPatchInformation[11].patchState);
#endif
#if     defined(__PATCH_13_1266__)
BOOL    *m_pbPatch_13_1266 = &(m_oPatchInformation[12].patchState);
#endif
#if     defined(__PATCH_14_1286__)
BOOL    *m_pbPatch_14_1286 = &(m_oPatchInformation[13].patchState);
#endif
