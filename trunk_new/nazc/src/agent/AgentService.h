...
#define TableJoin() 			m_pService->TableRejoin() 
...
// Operations
public:
	void	ImmediatelyShutdown(bool isShutdown);
	void	Reset();
	void	Shutdown();
...
protected:
	...
	CMeterDbWriter  theMeterDbWriter;
    ...
    //CMobileClient   theMobileClient;
#if defined(__TI_AM335X__)
    //CSmsWorker      theSmsWorker;
#endif
