...
int cmdJointableShow(IF4Wrapper *pWrapper, MIBValue *pValue, int cnt);						//  [4/27/2011 DHKim]
int cmdJointableAdd(IF4Wrapper *pWrapper, MIBValue *pValue, int cnt);							//  [4/27/2011 DHKim]
int cmdJointableDelete(IF4Wrapper *pWrapper,  MIBValue *pValue, int cnt);						//  [4/27/2011 DHKim]
int cmdJointableAddFile(IF4Wrapper *pWrapper,  MIBValue *pValue, int cnt);					//  [4/27/2011 DHKim]
#endif
