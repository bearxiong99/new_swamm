...
#define OBIS_LOAD_CONTROL_STATUS    33
#define OBIS_CUR_ACTIVE_FORWARD     34
#define OBIS_LP_SCHEMA              35
#define OBIS_LP_INTERVAL            36
#define OBIS_LOAD_CONTROL_ON        37
#define OBIS_LOAD_CONTROL_OFF       38
#define OBIS_LP_ENTRY_COUNT			39
#define OBIS_TIME_SYNC              40
#define OBIS_ENERGY_SCHEMA          41
#define OBIS_MAX_DEMAND_SCHEMA      42
#define OBIS_SAG                    43
#define OBIS_SWELL                  44
#define OBIS_INSTANTANEOUS          45

#define OBIS_METERING_DATA   		100
#define OBIS_DEFAULT   		        255


#define DLMS_SOURCE_ADDR            0x11
#define DLMS_DESTINATION_ADDR       0x0101
