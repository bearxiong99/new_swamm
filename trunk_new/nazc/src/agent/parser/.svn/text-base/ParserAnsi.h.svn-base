...
public:
    ...
    BOOL    UpdateLastPulse(ORDER order, int nLastPulseSize, int nChannelCount, void *endiLastPulse, void *pLastPulse);
    BOOL    UpdateBasePulse(ORDER order, int nBasePulseSize, int nChannelCount, void *endiBasePulse, void *pBasePulse);
    BOOL    UpdateLoadProfile(ORDER order, int nLpSize, int nChannelCount, int nInterval, int nLpCount, void *endiLp, void *pLoadProfile);
    BOOL    UpdateLog(ORDER order, int nEntryCount, TIMESTAMP *pCurrentTime, void *pEndiLog, void *pLogData);
...
public:  // Post Handler
    ...
    static void* fnPostS025(ANSISESSION *pSession, ONDEMANDPARAM *pOndemand, BYTE nTableType, WORD nTableNumber, 
            char *szTableData, WORD nTableLength);
    static void* fnPostS052BeforeTimesync(ANSISESSION *pSession, ONDEMANDPARAM *pOndemand, BYTE nTableType, WORD nTableNumber, 
            char *szTableData, WORD nTableLength);
    static void* fnPostS052AfterTimesync(ANSISESSION *pSession, ONDEMANDPARAM *pOndemand, BYTE nTableType, WORD nTableNumber, 
            char *szTableData, WORD nTableLength);
