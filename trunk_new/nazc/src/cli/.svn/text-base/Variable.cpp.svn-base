...
VAROBJECT	m_Root_node[] =
{
	...
	{   7,  "group", { {7,0,0}, VARSMI_OID, 3 },                VARATTR_READ, m_group_node, NULL, NULL }, //DHKim
...
VAROBJECT	m_mcu_node[] =
{
    ...
    {  12,    "mobileCfgEntry", { {2,12,0}, VARSMI_OPAQUE, sizeof(MOBILECFGENTRY) },
                                VARATTR_RW | VARATTR_LIST, m_mobileCfgEntry_node, NULL, NULL },
...
VAROBJECT	m_sysEntry_node[] =
{
    ...
    {  37,  "sysSecurityState", { {2,1,37}, VARSMI_BYTE, 1 },         VARATTR_RW, NULL, NULL, NULL },         //  [9/13/2010 DHKim]
	{   0,	NULL }
};
...
VAROBJECT	m_varEntry_node[] =
{
	...
	{  30,  "varEnableJoinControl",{ {2,2,30}, VARSMI_BOOL, 1 },VARATTR_RW, NULL, NULL, NULL},
	{   0,	NULL }
};
...
VAROBJECT	m_varValueEntry_node[] =
{
	...
	{  71,	"varTimesyncThresholdLow", { {2,3,71}, VARSMI_INT, 4 },         VARATTR_RW, NULL, NULL, NULL },
    ...
    {  82,  "varDefaultMeteringOption", { {2,3,82}, VARSMI_BYTE, 1 },       VARATTR_RW, NULL, NULL, NULL },
    ...
    {  86,  "varSchedulerType", { {2,3,86}, VARSMI_BYTE, 1 },               VARATTR_RW, NULL, NULL, NULL },
	{  87,	"varTimesyncThresholdHigh", { {2,3,87}, VARSMI_INT, 4 },        VARATTR_RW, NULL, NULL, NULL },
	{   0,	NULL }
};
...
{
    {   1,    "moduleType", { {2,12,1}, VARSMI_STRING, 32 },          VARATTR_RW, NULL, NULL, NULL },
    {   2,    "moduleFlag", { {2,12,2}, VARSMI_UINT, 4 },             VARATTR_RW, NULL, NULL, NULL },
    {   3,    "interface", { {2,12,3}, VARSMI_STRING, 64 },           VARATTR_RW, NULL, NULL, NULL },
    {   4,    "interfaceSpeed", { {2,12,4}, VARSMI_UINT, 4 },         VARATTR_RW, NULL, NULL, NULL },
    {   5,    "sms", { {2,12,5}, VARSMI_STRING, 64 },                 VARATTR_RW, NULL, NULL, NULL },
    {   6,    "smsSpeed", { {2,12,6}, VARSMI_UINT, 4 },               VARATTR_RW, NULL, NULL, NULL },
    {   0,    NULL }
};
