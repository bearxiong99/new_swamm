...
CLIPARAMCHECKER	m_CliParameters[] =
{
	...
	{ "dirpath",	"path or directory",			
					"Path or directory name",			check_string },
	...
	{ "ethtype",	"ethtype",				
					"Ethernet type (0:LAN,1:DHCP,3:PPP)", check_number }, // Issue #959 더이상 PPPoE는 지원하지 않는다
    { "evd",    	"delay",           
	...
	{ "kdsn",       "serial",				
					"Keukdong Meter Serial Number",		check_string },
	{ "kdopvalve",	"value status",				
					"0:open, 1:close, 2:standby",		check_opvalve },
#endif
	{ "lbt",		"lbt",					
 ...
 *
 * AM3352 + AMTelecom AME3352 일 경우
 *
 * Issue #1264 : TI에서 지원하는 Mobile module은 CSD/PACKET을 지원하지 않는다.
 * Issue #1264 : PXA에서도 Mobile module을 지원하게 수정한다.
 *
 */
	{ "mobmode",	"mobmode",				
					"Mobile mode (2:Always)", check_number },
	{ "mobtype",	"mobtype",				
					"Mobile type (0:NONE,1:GSM/GPRS,2:CDMA,3:PSTN)", check_number },
	{ "module",     "module",				
					"Mobile module (none, dtss800, mc55, ame5530, ge910, ue910)", check_string },
	{ "modflag",    "modflag",				
					"Mobile module interface flag", check_hex },
	{ "model",		"model",				
					"Sensor model",					    check_string },
	{ "mproperty",	"property value",				
					"Metering property value",			check_string },
	{ "msecurity",	"security",				
	...
	{ "property-group",	"property group",				
					"Property Group (Ex: METERING_PARAM, ...)",check_string },
	{ "property-key",	"property key",				
					"Parser name or Node Kind or ID",	check_string },
	{ "property-name",	"property name",				
					"Property Name (Ex: METERING_OPTION, METERING_OFFSET, ...)",check_string },
...
#ifdef __SUPPORT_KUKDONG_METER__
    { "status",         cmdShowKdMeterStatus,		     NULL,   			"%id", 
						"Show Keukdong meter status", 	CLIGROUP_USER, 		CLI_SKIPLOG,    CLI_NORMAL_CMD },
#endif
    { "pq",    	        cmdShowMeterPQ,			        NULL,   			"%id", 
						"Show power quality", 			CLIGROUP_USER, 		CLI_SKIPLOG,    CLI_NORMAL_CMD },
    { "property",    	cmdShowMeterPropertyById,		NULL,   			"%id*%property-group%property-name", 
						"Show meter properties", 		CLIGROUP_ADMIN, 	CLI_SKIPLOG,    CLI_HIDDEN_CMD },
#ifdef __SUPPORT_KUKDONG_METER__
    { "version",        cmdShowKdMeterVersion,	        NULL,   			"%id", 
						"Show Keukdong meter version", 	CLIGROUP_USER, 		CLI_SKIPLOG,    CLI_NORMAL_CMD },
#endif
    { NULL, NULL, NULL, NULL, NULL, 0, FALSE, FALSE }
};
...
CLIHANDLER  m_tblShowMetering[] =
{
    ...
    { "lp",             cmdShowLoadProfile,             NULL,               "%id*%@dd%@mm%@yy",
                        "Show load profile",            CLIGROUP_GUEST,     CLI_SKIPLOG,    CLI_HIDDEN_CMD },
#endif
    ...
    { "property",    	cmdShowMeterProperty,			NULL,   			"*%property-group%property-name%property-type%property-key", 
						"Show metering property", 		CLIGROUP_ADMIN, 	CLI_SKIPLOG,    CLI_HIDDEN_CMD },
    { "option",    	  	cmdShowMeteringOption,          NULL,               "*%property-type%property-key",
                        "Show metering options",    	CLIGROUP_GUEST,     CLI_SKIPLOG,    CLI_NORMAL_CMD },
    { "security",    	cmdShowMeterSecurity,			NULL,   			"*%property-type%property-key", 
						"Show metering security", 		CLIGROUP_ADMIN, 	CLI_SKIPLOG,    CLI_HIDDEN_CMD },
    { NULL, NULL, NULL,	NULL, NULL,	0, FALSE, FALSE }
};
...
#endif
    { "module",			cmdSetMobileModule,				NULL,				"%module%modflag%dirpath%speed*%dirpath%speed",	
						"Set Mobile Module", 			CLIGROUP_USER, 	    CLI_LOGGING,    CLI_NORMAL_CMD },
...
#ifdef __SUPPORT_KUKDONG_METER__
CLIHANDLER  m_tblSetMeter[] =
{
    { "pulse",          cmdSetMeterPulse,		        NULL,   			"%id%pulse", 
						"Set Keukdong meter pulse", 		CLIGROUP_USER, 		CLI_LOGGING,    CLI_NORMAL_CMD },
    { "serial",         cmdSetMeterSerial,	        	NULL,   			"%id%pulse%kdsn", 
						"Set Keukdong meter serial", 	CLIGROUP_USER, 		CLI_LOGGING,    CLI_NORMAL_CMD },
    { NULL, NULL, NULL, NULL, NULL, 0, FALSE, FALSE },
};
#endif
...
CLIHANDLER  m_tblSetServer[] =
{
    ...
    { "security",       cmdSetServerSecurity,			NULL,				"%onoff",		
						"Set Server Security Mode",		CLIGROUP_ADMIN,		CLI_LOGGING,    CLI_NORMAL_CMD },
#endif
    { NULL, NULL, NULL,	NULL, NULL,	0, FALSE, FALSE }
};
...
#ifdef __SUPPORT_KUKDONG_METER__
    { "meter",			NULL,	 	  					m_tblSetMeter,		NULL,		
						"Meter Setting",				CLIGROUP_USER, 		CLI_LOGGING,    CLI_NORMAL_CMD },
#endif
...
CLIHANDLER  m_tblAddMetering[] =
{
    { "option",	        cmdAddMeteringOption,		    NULL,				"%property-type%property-key%option%offset%count",		
						"Add metering option", 			CLIGROUP_ADMIN, 	CLI_LOGGING,    CLI_NORMAL_CMD },
    { "property",	    cmdAddMeterProperty,		    NULL,				"%property-group%property-name%property-type%property-key%mstype%mproperty",		
						"Add metering property", 		CLIGROUP_ADMIN, 	CLI_LOGGING,    CLI_HIDDEN_CMD },
    { "security",	    cmdAddMeterSecurity,		    NULL,				"%property-type%property-key%mstype%msecurity",		
						"Add metering security", 		CLIGROUP_ADMIN, 	CLI_LOGGING,    CLI_HIDDEN_CMD },
    { NULL, NULL, NULL,	NULL, NULL,	0, FALSE, FALSE }
};
...
CLIHANDLER  m_tblAdd[] =
{
    ...
    { "metering",	    NULL,		                    m_tblAddMetering,		NULL,		
						"Add metering property", 		CLIGROUP_ADMIN, 	CLI_LOGGING,    CLI_NORMAL_CMD },
...
CLIHANDLER  m_tblDeleteMetering[] =
{
    { "option",         cmdDeleteMeteringOption,        NULL,               "%property-type%property-key",
                        "Delete Metering option",       CLIGROUP_ADMIN,      CLI_LOGGING,    CLI_NORMAL_CMD },
    { "property",       cmdDeleteMeterProperty,         NULL,               "%property-group%property-name%property-type%property-key",
                        "Delete Metering property",     CLIGROUP_ADMIN,     CLI_LOGGING,    CLI_HIDDEN_CMD },
    { "security",       cmdDeleteMeterSecurity,         NULL,               "%property-type%property-key",
                        "Delete Metering security",     CLIGROUP_ADMIN,     CLI_LOGGING,    CLI_HIDDEN_CMD },
    { NULL, NULL, NULL,	NULL, NULL,	0, FALSE, FALSE }
};
...
CLIHANDLER  m_tblDelete[] =
{
    ...
    { "metering",       NULL,                           m_tblDeleteMetering,NULL,
                        "Delete Metering property",     CLIGROUP_USER,      CLI_LOGGING,    CLI_NORMAL_CMD },
...
#if 0
    2012.07.27 더이상 지원하지 않는다. ondemand metering을 사용하던지 set dr level 을 사용해야 한다
...
#ifdef __SUPPORT_KUKDONG_METER__
    { "valve",		    cmdOndemandValve,			    NULL,				"%id%kdopvalve",		
						"Ondemand valve operation",		CLIGROUP_USER,		CLI_LOGGING,    CLI_NORMAL_CMD },
#endif
    { NULL, NULL, NULL,	NULL, NULL,	0, FALSE, FALSE }
};
...
CLIHANDLER	m_CliEmergencyHandlers[] =
{
	...
	{ "shell",			cmdEmergencyShell,		NULL,	"%command",	"Shell Command", 		0, 	CLI_LOGGING,    CLI_HIDDEN_CMD },
