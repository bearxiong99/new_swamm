...
int cmdRebuildMember(CLISESSION *pSession, int argc, char **argv, void *pHandler);
...
int cmdShowAlarm(CLISESSION *pSession, int argc, char **argv, void *pHandler);
...
int cmdShowGroup(CLISESSION *pSession, int argc, char **argv, void *pHandler); // 실증단지
