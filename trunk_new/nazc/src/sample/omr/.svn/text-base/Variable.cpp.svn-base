...
//	{  18,	"verEntry", { {1,18,0}, VARSMI_STRING, 16 },        VARATTR_RW, m_verEntry_node, NULL, NULL },
	{  18,	"smivarEntry", { {1,19,0}, VARSMI_STREAM, 0 },      VARATTR_RW, m_smivarEntry_node, NULL, NULL },
//	{  20,	"pageEntry", { {1,20,0}, VARSMI_STREAM, 0 },        VARATTR_RW, m_pageEntry_node, NULL, NULL },
	{  19,	"gmtEntry", { {1,21,0}, VARSMI_STREAM, 11 },        VARATTR_RW, m_gmtEntry_node, NULL, NULL },
	{  20,	"omrEntry", { {1,101,0}, VARSMI_OPAQUE, 63 },		VARATTR_RW, m_omrEntry_node, NULL, NULL },
	{   0,	NULL }
};
...
VAROBJECT	m_omrEntry_node[] =
{
	{   1,	"omrMeterSerial", { {1,101,1}, VARSMI_STRING, sizeof(BYTE) * 32 },		VARATTR_RW, NULL, NULL, NULL },
	{   2,	"omrMeteringTime", { {1,101,2}, VARSMI_TIMESTAMP, sizeof(TIMESTAMP) },  VARATTR_RW, NULL, NULL, NULL },
	{   3,	"omrCurrActEnergy", { {1,101,3}, VARSMI_UINT, sizeof(UINT) },           VARATTR_RW, NULL, NULL, NULL },
	{   4,	"omrCurrReaEnergy", { {1,101,4}, VARSMI_UINT, sizeof(UINT) },           VARATTR_RW, NULL, NULL, NULL },
	{   5,	"omrPrevActEnergy", { {1,101,5}, VARSMI_UINT, sizeof(UINT) },           VARATTR_RW, NULL, NULL, NULL },
	{   6,	"omrPrevReaEnergy", { {1,101,6}, VARSMI_UINT, sizeof(UINT) },           VARATTR_RW, NULL, NULL, NULL },
	{   7,	"omrPrevCumMaxTot", { {1,101,7}, VARSMI_UINT, sizeof(UINT) },           VARATTR_RW, NULL, NULL, NULL },
	{   8,	"omrPowerPactor",   { {1,101,8}, VARSMI_UINT, sizeof(UINT) },           VARATTR_RW, NULL, NULL, NULL },
	{   0,	NULL }
};
